...
(function() {
  ...
  Sharkbone.Modules.Relational = (function() {

    function Relational() {}

    Relational.prototype.setupRelations = function() {
      var _this = this;
    ...
    Relational.prototype.fetchCollections = function() {
      var _this = this;
      if (this.isNew()) {
        return false;
      }
    ...
    Relational.prototype.createDotSyntaxCollectionGetters = function() {
      var _this = this;
    ...
    Relational.prototype.toJSON = function() {
      var attrs,
        _this = this;
      if ((Sharkbone.Config.ActiveRecord != null) && Sharkbone.Config.ActiveRecord) {
        ...
        return Relational.__super__.toJSON.apply(this, arguments);
      }
    };
  ...
  Sharkbone.ClassModules.Relational = (function() {

    function Relational() {}

    Relational.prototype.hasMany = function(key, options) {
      if (options == null) {
        options = {};
      }
      if (!key) {
    ...
    Relational.prototype.hasOne = function(key, options) {
      if (options == null) {
        options = {};
      }
      if (!key) {
  ...
  Sharkbone.Modules.CUDCallbacks = (function() {

    function CUDCallbacks() {}

    CUDCallbacks.prototype._afterSuccessfulCreate = [];

    CUDCallbacks.prototype._afterSuccessfulUpdate = [];

    CUDCallbacks.prototype._afterSuccessfulDestroy = [];

    CUDCallbacks.prototype._afterFailingCreate = [];

    CUDCallbacks.prototype._afterFailingUpdate = [];

    CUDCallbacks.prototype._afterFailingDestroy = [];

    CUDCallbacks.prototype.initializeDefaultCallbacks = function() {
    ...
    CUDCallbacks.prototype.callbacksFor = function(callbacksCollection, args) {
    ...
    CUDCallbacks.prototype.registerCallback = function(callbacksContainer, func) {
  ...
  Sharkbone.Modules.CUD = (function() {

    function CUD() {}

    CUD.prototype.create = function(options) {
      var _this = this;
    ...
    CUD.prototype.update = function(options) {
      var _this = this;
      if (typeof options.preventDefault === "function") {
        options.preventDefault();
      }
    ...
    CUD.prototype.destroy = function(id, options) {
      var _this = this;
    ...
    CUD.prototype.runCallbacksFor = function() {
      return typeof this.callbacksFor === "function" ? this.callbacksFor(arguments) : void 0;
    };

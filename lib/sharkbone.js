  ...
  Sharkbone.View = (function(_super) {
    ...
    View.prototype.create = function(options) {
      ...
      return this.collection.create(this.model, {
        success: function() {
          return _this.callbackFor(_this._afterSuccessfulCreate, [_this.model]);
        },
        error: function() {
          return _this.callbackFor(_this._afterFailingCreate, [_this.model]);
        }
      });
    };
    ...
    View.prototype.update = function(options) {
      ...
      return this.model.save({
        success: function() {
          return _this.callbackFor(_this._afterSuccessfulUpdate, [_this.model]);
        },
        error: function() {
          return _this.callbackFor(_this._afterFailingUpdate, [_this.model]);
        }
      });
    };
    ...
    View.prototype.destroy = function(id, options) {
      ...
      if ((id != null) && (this.collection != null)) {
        this.collection.get(id).destroy({
          success: function() {
            return _this.callbackFor(_this._afterSuccessfulDestroy, [_this.model]);
          },
          error: function() {
            return _this.callbackFor(_this._afterFailingDestroy, [_this.model]);
          }
        });

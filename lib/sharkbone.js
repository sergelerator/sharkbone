...
(function() {
  ...
  Date.seconds = function(n) {
    return n * 1000;
  };

  Date.minutes = function(n) {
    return Date.seconds(n) * 60;
  };

  Date.hours = function(n) {
    return Date.minutes(n) * 60;
  };

  Date.days = function(n) {
    return Date.hours(n) * 24;
  };

  Date.prototype.addTime = function(n) {
    return this.setTime(this.valueOf() + n);
  };

  Date.prototype.addSeconds = function(n) {
    return this.addTime(Date.seconds(n));
  };

  Date.prototype.addMinutes = function(n) {
    return this.addTime(Date.minutes(n));
  };

  Date.prototype.addHours = function(n) {
    return this.addTime(Date.hours(n));
  };

  Date.prototype.addDays = function(n) {
    return this.addTime(Date.days(n));
  };

  Number.prototype.errVal = NaN;
  ...
  Number.define('isOdd', function() {
    return this % 2;
  });

  Number.define('isEven', function() {
    return !this.isOdd();
  });

  Number.define('absolute', function() {
    if (this < 0) {
      return this.by(-1);
    } else {
      return this;
  ...
  Number.define('absoluteIncrement', function(x) {
    if (x == null) {
      x = 1;
    }
    if (this < 0) {
  ...
  Number.define('ceil', function() {
    if (this > this.toInt()) {
      return this.toInt().absoluteIncrement();
    } else {
      return this;
    }
  });

  Number.define('floor', function() {
    return this.toInt();
  });

  Number.define('next', function() {
    return this + 1;
  });

  String.define('trim', function() {
    return this.replace(/^\s+|\s+$/g, "");
  });

  String.define('ltrim', function() {
    return this.replace(/^\s+/g, "");
  });

  String.define('rtrim', function() {
    return this.replace(/\s+$/g, "");
  });

  String.define('unslash', function() {
    return this.replace(/^\/+|\/+$/g, "");
  });

  String.define('capitalize', function() {
    return this.charAt(0).toUpperCase() + this.slice(1);
  });

  String.define('camelize', function() {
    return _.map(this.split(/\s|_|-/), function(str) {
      return str.capitalize();
    }).join('');
  });

  String.define('underscored', function() {
    return this.replace(/([a-z\d])([A-Z]+)/g, '$1_$2').replace(/[-\s]+/g, '_').toLowerCase();
  });

  String.define('army', function(n) {
    var r;
    r = [];
    while (r.length < n) {
      r.push(this);
  ...
  String.define('leftFill', function(string, resultLength) {
    return (string.army(resultLength) + this).slice(resultLength * (-1));
  });

  String.define('toInt', function() {
    return parseInt(this);
  });

  String.define('toF', function() {
    return parseFloat(this);
  });

  String.define('isBlank', function() {
  ...
  Sharkbone.Mixin = (function() {
    ...
    Mixin.include = function(obj) {
      ...
      if ((_ref1 = proto.included) != null) {
        _ref1.apply(this.prototype, proto);
      }
      return this;
    };
  ...
  Sharkbone.Model = (function(_super) {
    ...
    Model.prototype.initialize = function() {
      ...
      options = arguments[1] || {};
      options['fetch_collections'] || (options['fetch_collections'] = false);
      if (Backbone.RelationalModel != null) {
  ...
  Sharkbone.Modules.CUD = {
    create: function(options) {
      ...
      if (options.originalEvent != null) {
        options = {};
      }
      return this.collection.create(this.model, _({
        success: function() {
    ...
    update: function(options) {
      ...
      return this.model.save(void 0, _({
        success: function() {
    ...
    destroyConfirmation: function(func) {
      this.__destroyConfirmation = typeof func === 'function' ? func : function() {
        return func;
      };
      return this;
    },
    __destroyConfirmation: function() {
      return confirm('This is a destructive operation and it cannot be undone. Confirm?');
    }
  };
  ...
  Sharkbone.Modules.Render = {
    ...
    renderData: function(template, context) {
      this.$el.append(template(context));
      return this;
    },
    renderResource: function(template, model) {
      this.$el.append(template());
      this.modelBinder.bind(model, this.el, this.bindings());
      return this;
    },
    renderCollection: function(template, collection, containerSelector) {
      this.$el.append(template());

...
(function() {
  ...
  Sharkbone.View = (function(_super) {
    ...
    View.prototype.initialize = function() {
      ...
      _.bindAll(this);
      this.initializeCallbackContainers();
      this.initializePaginatedCollection();
      this.initializeModelBinding();
      return this;
    };

    View.prototype.initializeCallbackContainers = function() {
    ...
    View.prototype.afterCreate = function() {
      return _(Array.prototype.slice.call(arguments)).each(function(func) {
        if (typeof func === 'function') {
          return this._afterSuccessfulCreate.push(func);
        }
      });
    };
    ...
    View.prototype.afterUpdate = function(func) {
      return _(Array.prototype.slice.call(arguments)).each(function(func) {
        if (typeof func === 'function') {
          return this._afterSuccessfulUpdate.push(func);
        }
      });
    };
    ...
    View.prototype.afterDestroy = function(func) {
      return _(Array.prototype.slice.call(arguments)).each(function(func) {
        if (typeof func === 'function') {
          return this._afterSuccessfulDestroy.push(func);
        }
      });
    };

    View.prototype.afterFailingCreate = function(func) {
      return _(Array.prototype.slice.call(arguments)).each(function(func) {
        if (typeof func === 'function') {
          return this._afterFailingCreate.push(func);
        }
      });
    };

    View.prototype.afterFailingUpdate = function(func) {
      return _(Array.prototype.slice.call(arguments)).each(function(func) {
        if (typeof func === 'function') {
          return this._afterFailingUpdate.push(func);
        }
      });
    };

    View.prototype.afterFailingDestroy = function(func) {
      return _(Array.prototype.slice.call(arguments)).each(function(func) {
        if (typeof func === 'function') {
          return this._afterFailingDestroy.push(func);
        }
      });
    };

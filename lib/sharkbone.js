...
(function() {
  ...
  Sharkbone.View = (function(_super) {
    ...
    View.prototype._afterSuccessfulCreate = [];

    View.prototype._afterSuccessfulUpdate = [];

    View.prototype._afterSuccessfulDestroy = [];

    View.prototype._afterFailingCreate = [];

    View.prototype._afterFailingUpdate = [];

    View.prototype._afterFailingDestroy = [];
    ...
    View.prototype.create = function(options) {
      ...
      return this.collection.create(this.model, {
        success: function() {
          return _this.callbacksFor(_this._afterSuccessfulCreate, [_this.model]);
        },
        error: function() {
          return _this.callbacksFor(_this._afterFailingCreate, [_this.model]);
        }
      });
    };
    ...
    View.prototype.update = function(options) {
      ...
      return this.model.save({
        success: function() {
          return _this.callbacksFor(_this._afterSuccessfulUpdate, [_this.model]);
        },
        error: function() {
          return _this.callbacksFor(_this._afterFailingUpdate, [_this.model]);
        }
      });
    };
    ...
    View.prototype.destroy = function(id, options) {
      ...
      if ((id != null) && (this.collection != null)) {
        this.collection.get(id).destroy({
          success: function() {
            return _this.callbacksFor(_this._afterSuccessfulDestroy, [_this.model]);
          },
          error: function() {
            return _this.callbacksFor(_this._afterFailingDestroy, [_this.model]);
          }
        });
    ...
    View.prototype.afterCreate = function() {
      var _this = this;
      return _(Array.prototype.slice.call(arguments)).each(function(func) {
        if (typeof func === 'function') {
          return _this._afterSuccessfulCreate.push(func);
        }
      });
    };
    ...
    View.prototype.afterUpdate = function() {
      ...
      return _(Array.prototype.slice.call(arguments)).each(function(func) {
        if (typeof func === 'function') {
          return _this._afterSuccessfulUpdate.push(func);
        }
      });
    };
    ...
    View.prototype.afterDestroy = function() {
      ...
      return _(Array.prototype.slice.call(arguments)).each(function(func) {
        if (typeof func === 'function') {
          return _this._afterSuccessfulDestroy.push(func);
        }
      });
    };

    View.prototype.afterFailingCreate = function() {
      var _this = this;
      return _(Array.prototype.slice.call(arguments)).each(function(func) {
        if (typeof func === 'function') {
          return _this._afterFailingCreate.push(func);
        }
      });
    };

    View.prototype.afterFailingUpdate = function() {
      var _this = this;
      return _(Array.prototype.slice.call(arguments)).each(function(func) {
        if (typeof func === 'function') {
          return _this._afterFailingUpdate.push(func);
        }
      });
    };

    View.prototype.afterFailingDestroy = function() {
      var _this = this;
      return _(Array.prototype.slice.call(arguments)).each(function(func) {
        if (typeof func === 'function') {
          return _this._afterFailingDestroy.push(func);
        }
      });
    };

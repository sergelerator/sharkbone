...
(function() {
    ...
    if (Backbone.RelationalModel != null) {
      Model.hasMany = function(key, options) {
        ...
        _.defaults(options, {
          ...
          collectionType: "" + (this.appNamespace()) + "Collections." + (_.pluralize(key).capitalize()) + "Collection"
        });
  ...
  Sharkbone.View = (function(_super) {
    ...
    View.prototype.initializePaginatedCollection = function() {
      if ((this.collection != null) && (this.collection.getPager != null)) {
        return this.listenTo(this.collection, 'reset', this.renderPagination);
      }
    };

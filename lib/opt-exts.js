...
(function() {
  ...
  OpalExtensions.View = (function(_super) {
    ...
    View.prototype.getResourceId = function(model) {
      var _ref;
      return (model != null ? model.id : void 0) || ((_ref = this.model) != null ? _ref.id : void 0);
    };

    View.prototype.indexPath = function(model) {
      var urlRoot;
